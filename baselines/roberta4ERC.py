...
from transformers import AutoConfig, AutoTokenizer, AutoModel, get_linear_schedule_with_warmup, RobertaPreTrainedModel, RobertaConfig, RobertaModel

class robertaERC(RobertaPreTrainedModel):
    def __init__(self, config: RobertaConfig, args):
...
if __name__ == '__main__':
    ...
    model = robertaERC.from_pretrained(
        args.model,
        config=config,
        args=args
    )
