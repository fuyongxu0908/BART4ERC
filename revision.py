...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, required=False, choices=['MELD', 'IEMOCAP', 'DailyDialog', 'EmoryNLP'], default='IEMOCAP')
    parser.add_argument('--train_with_generation', type=int, required=False, default=1, help="1: train with auxiliary generation task, 0: verse vice")
    parser.add_argument('--train_with_speaker', type=int, required=False, default=1, help="1: train with speaker, 0: verse vice")
